<?php
  ...
  $query = "SELECT * FROM Games LIMIT 20";
    ...
    <div class="tablePad">
      <tr>
        <form id='filterDropdownMenus' class="form-group">
          ...
          <td>
            <span <span class="dropdownPad">
              <select class="selectpicker" id="priceDropDown" name="priceDropDown">
                <option value="$0.00 - $59.99" id="anyPrice">$0.00 - $59.99</option>
          ...
          <span <span class="dropdownPad">
            <td><input type='submit' name='filterSearchButton' id='filterSearchBarButton' value='Search'></td>
          </span>
        </form>
        ...
        <div class="container">
          <form class="form-group">
            <td id='searchBarCell'>
              ...
              <span id="rightSearchButton">
                <input type='submit' name='searchBarButton' id='searchBarButton' value='Search'>
              </span>
            </td>
          </form>
        </div>
...
<div class="container">
  <table id='gamesTable'>
    <tr>
      <?php
        $count = 0;
        $query = "SELECT * FROM Games ORDER BY RAND() LIMIT 30";
        $result = mysqli_query($connect, $query);
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body' id='game_detail'>
        ...
        <div class='modal-footer'>
          <button type='button' id='home-add-to-cart'class='btn btn-default' data-dismiss='modal'>Add to Cart</button>
      </div>
    </div>
  </div>
</div>
